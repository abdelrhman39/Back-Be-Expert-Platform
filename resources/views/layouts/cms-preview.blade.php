<!DOCTYPE html>
<html class="no-js use-domain-a11y" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}" style="--header-height: 85px; --footer-height: 406px; --cms-preview-chrome-height: 56px;">
<head>
    <meta charset="utf-8">
