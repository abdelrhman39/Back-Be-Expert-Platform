...
@push('styles')
    ...
    <style>
        ...
        .auth-card {
            box-shadow: 0 18px 60px rgba(22, 93, 49, 0.14);
        ...
        .auth-side {
            position: relative;
            background: var(--gradient-hero, linear-gradient(135deg, #165d31 0%, #1b8354 48%, #135f3d 100%));
            color: #fff;
            overflow: hidden;
            display: flex;
        }
        ...
        .auth-side__glow--2 {
            ...
            background: radial-gradient(circle, rgba(184, 148, 63, 0.28) 0%, transparent 70%);
        }
        .auth-side__content {
            position: relative;
            z-index: 1;
        ...
        .auth-field .form-control:focus {
            ...
            box-shadow: var(--focus-ring, 0 0 0 3px rgba(27, 131, 84, 0.15));
        }
        .auth-field__toggle {
            background: #fff;
