...
class CmsBlockRegistry
{
    ...
    public static function types(): array
    {
        return [
            ...
            'path_cards' => ['label' => 'مسارات الجمهور', 'description' => 'بطاقات للأفراد والجهات والمدربين مع روابط'],
            'steps_grid' => ['label' => 'خطوات البدء', 'description' => 'مسار واضح من الاستكشاف حتى الشهادة'],
            'cta_banner' => ['label' => 'شريط دعوة للإجراء', 'description' => 'دعوة ختامية بأزرار أساسية وثانوية'],
